...
const MonitorDetail = () => {
  ...
  useEffect(() => {
    const fetchMonitor = async () => {
      try {
        setLoading(true);
        const [monitorData, documentsData] = await Promise.all([
          MonitorService.getMonitorById(id),
          DocumentService.getDocumentsForItem('Monitor', id)
        ]);
        ...
        <div className="detail-card">
          ...
          <div className="detail-grid">
            <div className="detail-item">
              ...
              <div className="detail-value">{formatDate(monitor.date_creation || monitor.date)}</div>
            </div>
            <div className="detail-item">
              <div className="detail-label">
                <Clock size={16} />
