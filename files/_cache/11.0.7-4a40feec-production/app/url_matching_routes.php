...
return [
    ...
    [ // $staticRoutes
        ...
        '/Form/Question/DropdownValues' => [[['_route' => 'glpi_form_question_dropdown_values', '_controller' => 'Glpi\\Controller\\Form\\QuestionDropdownValuesController'], null, ['POST' => 0], null, false, false, null]],
    ...
    [ // $dynamicRoutes
        ...
        108 => [[['_route' => 'authldap_replica_status', '_controller' => 'Glpi\\Controller\\Config\\LDAPController::testReplica'], ['authldaps_id', 'authldapreplicates_id'], ['POST' => 0], null, false, false, null]],
        155 => [[['_route' => 'glpi_form_destination_add', '_controller' => 'Glpi\\Controller\\Form\\Destination\\AddDestinationController'], ['form_id'], ['POST' => 0], null, false, false, null]],
        180 => [[['_route' => 'glpi_form_destination_purge', '_controller' => 'Glpi\\Controller\\Form\\Destination\\PurgeDestinationController'], ['form_id', 'destination_id'], ['POST' => 0], null, false, false, null]],
        194 => [[['_route' => 'glpi_form_destination_update', '_controller' => 'Glpi\\Controller\\Form\\Destination\\UpdateDestinationController'], ['form_id', 'destination_id'], ['POST' => 0], null, false, false, null]],
        214 => [[['_route' => 'glpi_form_destination_get_form', '_controller' => 'Glpi\\Controller\\Form\\Destination\\GetDestinationFormController'], ['form_id', 'destination_id'], ['GET' => 0], null, false, true, null]],
        235 => [[['_route' => 'glpi_form_render', '_controller' => 'Glpi\\Controller\\Form\\RendererController'], ['id'], ['GET' => 0], null, false, true, null]],
        270 => [[['_route' => 'glpi_add_form_translation', '_controller' => 'Glpi\\Controller\\Form\\Translation\\AddNewFormTranslationController'], ['form_id'], ['POST' => 0], null, false, false, null]],
        296 => [[['_route' => 'glpi_delete_form_translation', '_controller' => 'Glpi\\Controller\\Form\\Translation\\DeleteFormTranslationController'], ['form_id', 'language'], ['POST' => 0], null, false, false, null]],
        304 => [[['_route' => 'glpi_update_form_translation', '_controller' => 'Glpi\\Controller\\Form\\Translation\\UpdateFormTranslationController'], ['form_id', 'language'], ['POST' => 0], null, false, true, null]],
        355 => [[['_route' => 'glpi_delete_helpdesk_translation', '_controller' => 'Glpi\\Controller\\Helpdesk\\Translation\\DeleteHelpdeskTranslationController'], ['language'], ['POST' => 0], null, false, false, null]],
        363 => [[['_route' => 'glpi_update_helpdesk_translation', '_controller' => 'Glpi\\Controller\\Helpdesk\\Translation\\UpdateHelpdeskTranslationController'], ['language'], ['POST' => 0], null, false, true, null]],
        411 => [[['_route' => 'knowbaseitem_content', '_controller' => 'Glpi\\Controller\\Knowbase\\KnowbaseItemController::content'], ['knowbaseitems_id'], null, null, false, false, null]],
        429 => [[['_route' => 'knowbaseitem_full', '_controller' => 'Glpi\\Controller\\Knowbase\\KnowbaseItemController::full'], ['knowbaseitems_id'], null, null, false, false, null]],
        458 => [[['_route' => 'knowbaseitem_search', '_controller' => 'Glpi\\Controller\\Knowbase\\KnowbaseItemController::search'], ['itemtype', 'items_id'], null, null, false, true, null]],
        488 => [[['_route' => 'glpi_plugin_logo', '_controller' => 'Glpi\\Controller\\Plugin\\LogoController'], ['plugin_key'], ['GET' => 0], null, false, false, null]],
        520 => [[['_route' => 'glpi_progress_check', '_controller' => 'Glpi\\Controller\\ProgressController::check'], ['key'], ['GET' => 0], null, false, true, null]],
        575 => [[['_route' => 'glpi_ui_illustration_custom_illustration', '_controller' => 'Glpi\\Controller\\UI\\Illustration\\CustomIllustrationController'], ['id'], ['GET' => 0], null, false, true, null]],
        597 => [
